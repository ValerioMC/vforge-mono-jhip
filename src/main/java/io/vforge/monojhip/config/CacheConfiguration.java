package io.vforge.monojhip.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("vforgemono");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("vforgemono");
        ...
        config.getMapConfigs().put("io.vforge.monojhip.domain.*", initializeDomainMapConfig(jHipsterProperties));
